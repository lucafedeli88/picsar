#ifndef __OMP_EXAMPLE_BW_TABLEGEN__
#define __OMP_EXAMPLE_BW_TABLEGEN__
...
*/
template <typename Real>
auto generate_pair_table(
    Real chi_min,
    Real chi_max,
    int chi_size,
    int frac_size)
{
    return xgenerate_pair_table(
        chi_min,
        chi_max,
        chi_size,
        frac_size);
...
#endif //__OMP_EXAMPLE_BW_TABLEGEN__
